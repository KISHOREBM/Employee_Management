"""
Django settings for empback project.
...
SECRET_KEY = 'django-insecure-474^oqye*&(9l_e=qrhmy^^h#9z1e^+vfj@_*&7z^9edrf1vqx'

DEBUG = True

ALLOWED_HOSTS = [
    'employee-management-one-nu.vercel.app',
    '127.0.0.1',  
    'localhost',   
]
...
WSGI_APPLICATION = 'empback.wsgi.application'
